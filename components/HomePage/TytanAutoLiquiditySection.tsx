    ...
    return (
        <div className={`bg-black py-20 `}>
            <div className={`mx-auto max-w-[1000px] p-4`}>
                <AttentionSeeker triggerOnce effect={'shakeX'}>
                    ...
                    <Fade triggerOnce cascade={true} direction={'up'}>
                        ...
                        <div className={`max-w-[482px] w-full`}>
                            <ResponsiveBody1 className={`text-center`}>
                                ...
                                automatic liquidity into the market. On each buy or sell order there is a 4% tax fee
                                that
                                automatically gets stored into an Auto-LP wallet and built into our protocol’s smart
                                contract is the mechanism which smartly takes the 50% of the amount of TYTAN stored in
                                the
                        ...
                        <div className={`max-w-[482px] w-full`}>
                            <ResponsiveBody1 className={`text-center`}>
                                ...
                                automatically added as new, additional liquidity into the market pair and raising the
                                amount
                                ...
                                market slippage. It will also aid in maintaining protocol stability to make sure the APY
                                is
